 ...
 */
export default async function exit( message, error_type = new Error( `${process.title} ♠ error - internal` ), exit_code = 1, process_exit = true ){
  ...
  if( !( type instanceof Error ) && process_exit )
